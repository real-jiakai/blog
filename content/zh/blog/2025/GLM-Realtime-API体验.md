...
于是乎，我便将智谱官方文档有关Realtime API的内容发送给Claude，在和Claude反复拉扯以及结合Perplexity Debug Claude代码后，最终整出了GLM-Realtime API演示。原演示站已下线，但可以查看[存档副本](https://web.archive.org/web/20250322110623/https://glm-realtime.gujiakai.top/)。
