...
![Don't underestimate Claude - Image 1](https://cdn.sa.net/2025/04/29/UrXDVe6ptnFuYLK.webp)

![Don't underestimate Claude - Image 2](https://cdn.sa.net/2025/04/29/oNWBEKbes2Pluv4.webp)
...
![Claude 3.7 Sonnet programming ability far ahead](https://cdn.sa.net/2025/03/01/qyGWDniPKteXpxN.webp)

## Update (2025.2.26)

Claude Code is totally a toy. Yesterday saw a blogger use Claude Code to add new Features to their project. I don't have good ideas either—randomly had Claude Code make a [Hungry Bear](https://bear.gujiakai.top). Natural language programming took over 1 hour—feels inferior to Cursor, Windsurf and other AI editors. Still need to learn programming properly. Natural language programming process is extremely difficult. The more tech you know, plus Claude assistance, the better you can hit targets!

![Using Claude Code for natural language programming](https://cdn.sa.net/2025/02/26/LAVcJFM6xzBhXDH.webp)

Anthropic official Twitch livestream of Claude playing Pokemon: https://www.twitch.tv/claudeplayspokemon

![Anthropic official Twitch livestream of Claude playing Pokemon](https://cdn.sa.net/2025/02/26/cI1Lirw4OotgVlT.webp)

## Update (2025.2.25)

Netizen comment: "If you know coding, Claude will make you a coding god!"

![Netizen comment](https://cdn.sa.net/2025/02/25/e3WUgGXoLO8kzqY.webp)

Another case update: generating Gomoku game

![Gomoku game](https://cdn.sa.net/2025/02/25/INeHmg2URJZbvGp.webp)
...
First look at official News main content[^1]. This time chose Phind's Claude 3.7 Sonnet for summarizing.

![Official News Phind summary 1](https://cdn.sa.net/2025/02/25/hdVIUKTwnB3meoX.webp)

![Official News Phind summary 2](https://cdn.sa.net/2025/02/25/l2jwEuYebItxUa1.webp)
...
![Phind's explanation of hybrid reasoning model](https://cdn.sa.net/2025/02/25/DMpjBe1JHIF3Pal.webp)

![Grok3 DeepSearch's explanation of hybrid reasoning model](https://cdn.sa.net/2025/02/25/2XYanzfoTFuPOI5.webp)
...
Official research blog—Claude's extended thinking[^2], Phind summary:

![Phind summary of official research blog 1](https://cdn.sa.net/2025/02/25/DXqWJVi513KEu4k.webp)

![Phind summary of official research blog 2](https://cdn.sa.net/2025/02/25/EWlIL5psUKNTO6X.webp)

Differences from previous reasoning models:

![Claude 3.7 Sonnet model differences from previous reasoning models](https://cdn.sa.net/2025/02/25/quJX2E3IN8yMHUY.webp)

Claude 3.7 System Card[^3], Claude 3.7 Sonnet Extended summary:

![Claude 3.7 Sonnet Extended summarizes its System Card](https://cdn.sa.net/2025/02/25/653DqbyzBCNjWe9.webp)

- GitHub Integration[^4]

![Claude's GitHub integration feature](https://cdn.sa.net/2025/02/25/9MyusGxcE2AR38X.webp)
...
![Adding GitHub repo files to Claude Chat experience](https://cdn.sa.net/2025/02/25/srAKYLuTJpeyMdn.webp)
...
![Claude GitHub integration only chats about file content, can't operate code](https://cdn.sa.net/2025/02/25/WoDbl9jxkeMdf7n.webp)

- Claude Code[^5]

Phind summary:

![Phind's Claude Code summary 1](https://cdn.sa.net/2025/02/25/dHlp4e5wyQDKM8r.webp)

![Phind's Claude Code summary 2](https://cdn.sa.net/2025/02/25/y7mA5HLaO4ExdlT.webp)
...
# Reload bash config to make fnm command available
source ~/.bashrc
# Install Node.js version 22.14.0
fnm install 22.14.0
# Set Node.js version 22.14.0 as current version
fnm use v22.14.0
# Globally install latest pnpm 10.x version
npm install -g pnpm@latest-10
# Set up pnpm config
pnpm setup
# Reload bash config again to make pnpm command available
source ~/.bashrc
# Globally install Claude Code CLI tool
pnpm add -g @anthropic-ai/claude-code
# Create a new directory named claude-test-snake-game-in-terminal
mkdir claude-test-snake-game-in-terminal
# Enter the newly created directory
cd claude-test-snake-game-in-terminal
# Start Claude Code CLI tool
claude
```

![Claude Code demo image 1](https://cdn.sa.net/2025/02/25/A6uRHGS2irk3twL.webp)

![Claude Code is at full capacity](https://cdn.sa.net/2025/02/25/FTQDR68NiU2zvCt.webp)

Claude Code currently at full capacity—will try when spots open.

Reportedly has Easter egg. Stickers only ship within US.

![Claude Code reportedly has Easter egg](https://cdn.sa.net/2025/02/25/wjCK64HbvfDtqlE.webp)

![Gemini's explanation of tweet image](https://cdn.sa.net/2025/02/25/lvkfIrwSdoh4tDA.webp)

via: https://x.com/nrehiew_/status/1894112547873210710

- thinking budget

![Anthropic's thinking budget tweet](https://cdn.sa.net/2025/02/25/2Vq9JwoWh7aMQtH.webp)
...
![DeepSeek official docs mention reasoning_effort content](https://cdn.sa.net/2025/02/25/bLI5jWfmkqSzMpu.webp)
...
![Claude 3.7 Sonnet Extended chain-of-thought collapsed by default](https://cdn.sa.net/2025/02/25/jNzPW3kaoiTwUMy.webp)

Reportedly harmful content in chain-of-thought not shown to users.

![Harmful content not included in chain-of-thought](https://cdn.sa.net/2025/02/25/bYILMljKxP2ZpRT.webp)
...
![Claude coding ability far ahead](https://cdn.sa.net/2025/02/25/vUon1EyAsklW48O.webp)
...
![Claude 3.7 Sonnet Thinking tops livebench.ai](https://cdn.sa.net/2025/02/25/3q9wK5DnEps2Jtc.webp)
...
![Phind's aider leaderboard analysis](https://cdn.sa.net/2025/02/25/KatRTb8erqHgwzs.webp)
...
![Claude code comments better follow instructions](https://cdn.sa.net/2025/02/25/GgmRZ958d34ztpf.webp)
...
![Interesting case 1](https://cdn.sa.net/2025/02/25/ol3Pvgmc4qbF7zn.webp)
...
![Interesting case 2-1](https://cdn.sa.net/2025/02/25/5C4IsxJToW8blgc.webp)

Extended:

![Interesting case 2-2](https://cdn.sa.net/2025/02/25/RZDjXFOl5VQEsdS.webp)
...
![Interesting case 3-1](https://cdn.sa.net/2025/02/25/mQpB5DFZGN8SK2a.webp)

via: https://claude.ai/share/13475764-f78e-4b1b-8be7-9fb438cd540e

Extended:

![Interesting case 3-2](https://cdn.sa.net/2025/02/25/vTFjS2WIalOXGzn.webp)

Saw [netizen](https://x.com/theo/status/1894101944068641241) on X say Claude 3.7 Sonnet Extended can't pass rotating ball test—my test passed.
...
![Interesting case 4-1](https://cdn.sa.net/2025/02/25/8pbsND6znJlmUFr.webp)

Extended:

![Interesting case 4-2](https://cdn.sa.net/2025/02/25/4fGrtZzyOmgboE9.webp)
...
![Anthropic's Citation feature provides significant value for RAG applications](https://cdn.sa.net/2025/02/25/jRfige2n69Bbz1O.webp)
