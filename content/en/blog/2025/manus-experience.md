...
A recent archived blog post, [After Kimi K2 Release: No Longer Just ChatBot](https://web.archive.org/web/20260404150133/https://bigeagle.me/2025/07/kimi-k2/), had a statement that resonated with me: `The vast majority of Agent products, without Claude, are nothing`. The original page is offline. Reality is indeed so. Claude leads by far in Agents. Looking forward to Anthropic upgrading web Extended Thinking to Agent in the second half of the year after Claude Code programming Agent, while maintaining classic LLM.
