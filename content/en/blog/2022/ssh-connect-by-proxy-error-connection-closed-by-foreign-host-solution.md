---
title: "Fix SSH Proxy 'Connection Closed by Foreign Host'"
...
summary: "A two-hour troubleshooting account of fixing SSH proxy sessions that ended with 'Connection closed by foreign host.'"
showtoc: true
---
