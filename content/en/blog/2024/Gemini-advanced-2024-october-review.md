...
![Gemini can't summarize YouTube video analysis](https://cdn.sa.net/2025/01/30/oFKnxC6tJGBqDQ8.webp)
...
![Gemini Advanced December update](https://cdn.sa.net/2024/12/15/uTgBdVEZeMPwj7l.webp)
...
![Renewed Google One AI Premium](https://cdn.sa.net/2024/11/16/Y964c82gdwXeU5L.webp)
...
![Gemini App update announcement](https://cdn.sa.net/2024/11/02/Vm5h2rkZ7M8aLpu.png)
...
![Gemini Grounding works better with English](https://cdn.sa.net/2024/11/02/T3AxyjZIRCEdw91.webp)

English replies all correct, Chinese reply had wrong Tatum score.

![Celtics latest game scores](https://cdn.sa.net/2024/11/02/fVmc68rn3JLotBS.webp)

Can't search my blog yet.

![Can't search my blog](https://cdn.sa.net/2024/11/02/tRb8xrMSwLeVjFX.webp)

Probably my site's weight isn't enough—ranking too low on Google caused Grounding response to return empty array.

![Maybe site weight too low, causing Grounding response to be empty array](https://cdn.sa.net/2024/11/02/VDiJmxfNRkr9Xg3.webp)
...
![Google Grounding collects user data to improve products](https://cdn.sa.net/2024/11/02/4qFvZ7TMNX1BYAL.webp)
...
![Paid API not used for model training](https://cdn.sa.net/2024/11/02/8oQqmJTkv3sLtSP.webp)
...
![If you're not paying for the product, you are the product](https://cdn.sa.net/2024/11/02/upLlJ4DG3r6Axks.webp)
...
![Gemini chat history will be reviewed](https://cdn.sa.net/2024/11/02/VoD7FNafk5GBnKC.webp)

Trust it once—turning off activity won't feed my data to AI training. Anyway this extension is optional for me.

![Once tried turning off Gemini activity](https://cdn.sa.net/2024/11/02/hLvjKENHfGbJFos.webp)
...
![ByteDance's PixelDance may use short video data for training](https://cdn.sa.net/2024/11/02/LrkfqFJd3vglReA.webp)

Look at LinkedIn's updated user agreement—also starting to use user data to train AI.

![LinkedIn also starting to use user data to train AI](https://cdn.sa.net/2024/11/02/LNlWf8zvTMRSj7q.webp)
...
![Gemini Advanced referral lets friends get 4 months free](https://cdn.sa.net/2024/11/02/YIao5H47rjAfRzi.webp)
...
![Gemini highly integrated with Google ecosystem](https://cdn.sa.net/2024/11/02/kWslJvbDICaL78g.webp)
...
![Gemini Advanced can summarize YouTube videos](https://cdn.sa.net/2024/11/02/lhJY78LQrAT3kE1.webp)

Summarizing YouTube video summaries—Gemini API doesn't support, only Gemini app supports.

![Gemini API doesn't support summarizing YouTube video summaries](https://cdn.sa.net/2024/11/02/hYdKc8ZrlExPaeg.webp)
...
![Non-hands-on YouTube videos, I'll use Gemini to summarize in the future](https://cdn.sa.net/2024/11/02/y4JvfHrDtA7wquE.webp)
...
![Basic Gemini without membership can also summarize YouTube videos](https://cdn.sa.net/2024/11/02/UpqQYIrKCfM5mTF.webp)

Even can summarize instructor's beautiful life—must admire Gemini 1.5 Pro's video processing ability.

![Using Gemini Advanced to summarize instructor's beautiful life](https://cdn.sa.net/2024/11/02/iYNxvdsEXzgWoj3.webp)

Note: original instructor video has no CC subtitles. Multimodal Gemini is impressive.

![Gemini summarizes YouTube videos using multimodal ability, not subtitles](https://cdn.sa.net/2024/11/02/ArNBoI6UPjLnRQG.webp)
...
![Gemini model's multimodal capability is unmatched](https://cdn.sa.net/2024/11/02/vn9UGqwelmEQtxP.webp)
...
![Gemini Advanced can solve Kun puzzle](https://cdn.sa.net/2024/11/02/OJ65g7wqc1UY3mx.webp)

Code comments can also complete in sections.

![Gemini Advanced code comments section can also be complete](https://cdn.sa.net/2024/11/02/s8xdSm1cEYIO72L.webp)
...
![Gemini sensitive to US election](https://cdn.sa.net/2024/11/02/jPTveNZmHXuYkCt.webp)

+ Supported file types not as good as GPT, Claude

Like not supporting .ipynb file upload.

![Gemini doesn't support .ipynb file upload](https://cdn.sa.net/2024/11/02/HFmGXS9uy5WeEJT.webp)

Uploading Colab .ipynb file from Google Drive—directly shows folder empty.

![Gemini doesn't support .ipynb files](https://cdn.sa.net/2024/11/02/DsNkYGHmtodAaOW.webp)

Actually Colab Notebooks folder isn't empty.

![Gemini doesn't support .ipynb files](https://cdn.sa.net/2024/11/02/iD4V92GFIyzfMZb.webp)
...
![GPT 4o's comment version, every line comment is the same](https://cdn.sa.net/2024/11/02/OMQepikTU3cmVyr.webp)

Claude's is also defective.

![Claude also can't give complete .ipynb code comments](https://cdn.sa.net/2024/11/02/V76d1PZ2l8cJQxA.webp)
...
![Gemini Advanced initially writing code comments, truncated after small section](https://cdn.sa.net/2024/11/02/wJrHZh4FTcotjkz.webp)

In contrast, API console—wow, really presented all line comments.

![API console, Gemini presented all line code comments](https://cdn.sa.net/2024/11/02/gAd1YhCimrOaLUK.webp)

Claude writing comments exceeded context window. But can continue.

![Claude writing comments exceeded context window. But can continue](https://cdn.sa.net/2024/11/02/XGYNlJtz35pDOgw.webp)

If using Google's Double Check, don't ask in Chinese, especially programming questions—probably checks CSDN sites.

Gemini dumb replies:

![Gemini dumb reply](https://cdn.sa.net/2024/11/02/Z3YdLDFKeSmCWxs.webp)

![Gemini dumb reply](https://cdn.sa.net/2024/11/02/qiwAcxpMumld23I.webp)

![GPT 4o can understand context](https://cdn.sa.net/2024/11/02/VGiomMTNuE5Pa9S.webp)
...
![Gemini writing Chinese comments sometimes also lazy](https://cdn.sa.net/2024/11/02/4GhiORfDu18FoyU.webp)

Gemini Advanced is simply an idiot.

![Gemini Advanced confused, can't provide code comments](https://cdn.sa.net/2024/11/02/LUEKm7hsYvpHCzM.webp)

Look at o1-mini's reply—so complete.

![o1-mini code comments are very complete](https://cdn.sa.net/2024/11/02/VOsg6vtEU7FDMY5.webp)

Imagen3 can't generate people? I remember free version doesn't support generating people, Advanced version does.

![Imagen3 can't generate people?](https://cdn.sa.net/2024/11/02/WkL6bRxhIT4icwP.webp)

Dumb Gemini can't even access papers.

![Gemini can't access arxiv](https://cdn.sa.net/2024/11/02/s1mSiBQrnhIvOd8.webp)

Can only upload one image at a time—limits my expression.

![Gemini can only upload one image at a time](https://cdn.sa.net/2024/11/02/hSuRf9lXWw2EgPn.webp)

Console is way better than Gemini App. Garbage Gemini. Google doesn't put effort into Gemini App.

![Console can upload multiple images](https://cdn.sa.net/2024/11/02/EDfiLaP5IhUJvOg.webp)
...
![Changed question phrasing, responded normally again](https://cdn.sa.net/2024/11/02/FmiZRN42AgVkeBv.webp)
...
![Cancelled Google One AI Premium subscription](https://cdn.sa.net/2024/11/02/bCJajLMXFAEyntN.webp)
