      ...
      1: [
        function (t, e, n) {
          ...
          _.prototype._initTouchEvents = function () {
            ...
            a.addEventListener(f.move, this._preventMove, {passive: true});
            ...
            this.panel.addEventListener(f.start, this._resetTouchFn, {passive: true});
            ...
            this.panel.addEventListener(f.end, this._onTouchEndFn, {passive: true});
            ...
            this.panel.addEventListener(f.move, this._onTouchMoveFn, {passive: true});
            return this;
          };
      ...
      2: [
        function (t, e, n) {
          ...
          function o(t, e, n) {
            ...
            t.addEventListener(e, r, {passive: true});
            return r;
          }
          e.exports = o;
        },
